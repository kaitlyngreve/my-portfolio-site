...
function ProjectCard({ project }) {
    ...
    return (
        <div>
            <a className="project-tile-link" href={project.github_url} target='_blank' rel='noreferrer'>
                <div className='grid-item'>
                    ...
                    <div className="tech-items-wrapper">
                        <p className="tech" >{project.tech_stack[0]}</p>
                        <p className="tech" >{project.tech_stack[1]}</p>
                        <p className="tech" >{project.tech_stack[2]}</p>
                        {project.tech_stack.length <= 3 ? '' :
                            <p className="tech" >{project.tech_stack[3]}</p>
                        }
                        {project.tech_stack.length <= 4 ? '' :
                            <p className="tech" >{project.tech_stack[4]}</p>
                        }
                    </div>
