    ...
    return (
        <div>
            ...
            <div className='project-container'>
                ...
                <a classname='project-link' href={project.github_url} target="_blank">
                ...
                {/* ternary for displaying deployed url if project has a deployed url */}
                {project.deployed_url === '' ? '' :
                    <a classname='project-link' href={project.deployed_url} target='_blank'>
