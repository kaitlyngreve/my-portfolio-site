...
function Contact() {
    return (
        <div className="contact-container container" id='contact'>
            ...
            <p className="contact-content">If you've made it this far, thank you! <br />Are you hiring? <br />I am currently searching for a role as a software engineer and would love to hear from you. Send me an email!
            </p>
